...
function onReceiveMessageCallback(event) {
  ...
  if (receivedSize === file.size) {
    ...
    document.getElementById("videoTag").src = downloadDiv.href; // esta linea es la magica
    ...
    bitrateDiv.innerHTML = '<strong>Velocidad promedio:</strong> ' +
        bitrate + ' kbits/sec (max: ' + bitrateMax + ' kbits/sec)' +
        ' <a href="https://www.youtube.com/user/elratonmundialista">mirá, un ratón que juega al futbol: </a>'
